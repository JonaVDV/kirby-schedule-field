(function() {
      ...
      props: {
        fields: {
          day: {
            ...
            type: "select",
            options: [
              { value: 0, text: window.panel.$t("dialog.event.edit.day.sunday") },
              // Translate day
              { value: 1, text: window.panel.$t("dialog.event.edit.day.monday") },
              // Translate day
              {
                value: 2,
              ...
              // Translate day
              { value: 5, text: window.panel.$t("dialog.event.edit.day.friday") },
              // Translate day
              {
                value: 6,
  ...
  var _sfc_render$3 = function render() {
    ...
    return _c("li", { staticClass: "event", style: { top: _vm.cssTopValue + "%" }, on: { "dblclick": function($event) {
      $event.stopPropagation();
      return _vm.editEvent(_vm.event);
    } } }, [_c("div", { staticClass: "event-content" }, [_c("span", { staticClass: "event-title" }, [_vm._v(_vm._s((_a = _vm.item) == null ? void 0 : _a.title))]), _c("span", { staticClass: "event-time" }, [_vm._v(_vm._s(_vm.event.startTime.substring(0, 5)) + " - " + _vm._s(_vm.event.endTime.substring(0, 5)))]), _c("span", { staticClass: "event-location" }, [_vm._v(_vm._s((_b = _vm.item) == null ? void 0 : _b.location))])]), _c("k-options-dropdown", { staticClass: "event-options-trigger", attrs: { "options": _vm.itemOptions, "text": false, "icon": "dots", "size": "xs" }, on: { "action": function($event) {
  ...
  __component__$3.options.__file = "/home/jona-vdv/Documents/programming/projects/kirby-schedule-field/packages/kirby-schedule-field/src/components/schedule-event-item.vue";
  ...
  const _sfc_main$2 = Vue.defineComponent({
    ...
    methods: {
      ...
      handleItemDrop(changeEvent, targetDate, targetHour) {
        ...
        if (changeEvent.added) {
          ...
          } else if (changeEvent.added.element && changeEvent.added.element.id && !changeEvent.added.element.instanceId) {
            const addedElement = changeEvent.added.element;
            const targetStartTime = String(targetHour).padStart(2, "0") + ":00:00";
            const targetEndTime = String(targetHour + 1).padStart(2, "0") + ":00:00";
            openTimeDialog(
              (timeData) => {
                ...
                const newEvent = {
                  ...
                  recurringEndDate: timeData.recurring ? timeData.recurringEndDate : null
                };
      ...
      handleMove(event, newDayIndex, newStartHour) {
        ...
        const newStartDate = currentStartDate.startOf("week").add(newDayIndex, "day").format("YYYY-MM-DD");
        const newEvent = {
      ...
      getEventsForslot(dayIndex, startHour) {
        ...
        const filteredEvents = this.events.filter((event) => {
          if (event.dayOfWeek !== dayIndex || parseInt(event.startTime.split(":")[0], 10) !== startHour) {
            return false;
          }
          if (!event.recurring) {
    ...
    computed: {
      ...
      datesOfCurrentWeek() {
        return Array.from(
          { length: 7 },
          (_, i) => this.startOfWeek.add(i, "day")
        );
      },
      /**
       * @return {import('./schedule-event-item.vue').Event[]}
  ...
  var _sfc_render$2 = function render() {
    var _vm = this, _c = _vm._self._c;
    _vm._self._setupProxy;
    return _c("div", {}, [_c("table", { staticClass: "schedule-grid" }, [_c("thead", [_c("tr", { staticClass: "schedule-header" }, [_c("th", { staticClass: "time-header" }, [_vm._v(_vm._s(_vm.$t("field.schedule.time")))]), _vm._l(_vm.datesOfCurrentWeek, function(date, dayIndex) {
      return _c("th", { key: date.format("YYYY-MM-DD"), staticClass: "day-header", class: {
        "hidden-mobile": dayIndex !== _vm.currentDay.day()
      }, attrs: { "data-mobile": "true" } }, [_c("span", [_vm._v(" " + _vm._s(date.format("dddd")) + " ")]), _c("span", [_vm._v(" " + _vm._s(date.format("MMM-DD")) + " ")])]);
    })], 2)]), _c("tbody", _vm._l(_vm.getTimeRange, function(hour) {
      return _c("tr", { key: hour, staticClass: "schedule-slots" }, [_c("td", { staticClass: "time-cell", attrs: { "data-mobile": "true" } }, [_vm._v(" " + _vm._s(String(hour).padStart(2, "0")) + ":00 ")]), _vm._l(_vm.datesOfCurrentWeek, function(date, dayIndex) {
        return _c("td", { key: date.format("dddd") + "-" + hour, staticClass: "schedule-cell", class: {
          "active-day-cell": _vm.currentDay.day() === dayIndex,
          "hidden-mobile": dayIndex !== _vm.currentDay.day()
        }, attrs: { "data-day": date.format("dddd"), "data-hour": hour, "data-mobile": "true" } }, [_c("k-draggable", { staticClass: "target-list", attrs: { "options": _vm.draggableOptions, "list": _vm.getEventsForslot(dayIndex, hour) }, on: { "change": function($event) {
          return _vm.handleItemDrop($event, date, hour);
        }, "start": _vm.handleDragStart, "end": _vm.handleDragEnd } }, _vm._l(_vm.getEventsForslot(dayIndex, hour), function(event, index) {
          return _c("ScheduleEventItem", { key: event.instanceId, style: _vm.getEventDynamicStyle(index, _vm.getEventsForslot(dayIndex, hour)), attrs: { "event": event }, on: { "delete-event": function($event) {
            return _vm.$emit("delete-event", event.instanceId);
          }, "edit-event": (instanceId, newValues) => _vm.$emit("edit-event", instanceId, newValues) } });
        }), 1)], 1);
      })], 2);
    }), 0)])]);
  };
  ...
  __component__$2.options.__file = "/home/jona-vdv/Documents/programming/projects/kirby-schedule-field/packages/kirby-schedule-field/src/components/schedule-table.vue";
  ...
  var _sfc_render$1 = function render() {
    var _vm = this, _c = _vm._self._c;
    _vm._self._setupProxy;
    return _c("k-field", _vm._b({ staticClass: "k-schedule-items-container" }, "k-field", _vm.$props, false), [_c("k-button", { attrs: { "icon": "add" }, on: { "click": _vm.openItemAdd } }, [_vm._v(" " + _vm._s(_vm.$t("field.schedule.addEvent")) + " ")]), _c("k-draggable", { staticStyle: { "--columns": "12", "gap": "0.5rem" }, attrs: { "list": _vm.items, "options": _vm.sourceOptions, "element": "k-grid" } }, _vm._l(_vm.items, function(item) {
      return _c("li", { key: item.id, staticClass: "list-item", style: { backgroundColor: item.color }, on: { "dblclick": function($event) {
        return _vm.editItem(item, item.id);
      } } }, [_c("div", { staticClass: "list-item-content", style: { color: item.color } }, [_c("span", { staticClass: "list-item-title" }, [_vm._v(" " + _vm._s(item.title) + " ")]), _c("k-options-dropdown", { staticClass: "event-options-trigger", attrs: { "options": _vm.itemOptions, "text": false, "icon": "dots", "size": "xs" }, on: { "action": function($event) {
  ...
  __component__$1.options.__file = "/home/jona-vdv/Documents/programming/projects/kirby-schedule-field/packages/kirby-schedule-field/src/components/create-item.vue";
  ...
  const _sfc_main = Vue.defineComponent({
    ...
    methods: {
      ...
      moveEvent({ instanceId, newValues }) {
        const index = this.events.findIndex((event2) => event2.instanceId === instanceId);
        if (index === -1) {
  ...
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-field", _vm._b({ staticClass: "k-schedule-field" }, "k-field", _vm.$props, false), [_c("div", [_c("CreateItem", { attrs: { "items": _vm.items, "fields": _vm.fields, "endpoints": _vm.endpoints }, on: { "delete-items": _vm.deleteItem, "add-items": _vm.saveItem, "edit-items": _vm.editItem } })], 1), _c("div", { staticClass: "schedule-navigation" }, [_c("div", { staticClass: "schedule-navigation-buttons" }, [_c("k-button", { attrs: { "icon": "angle-left", "variant": "filled", "theme": "blue" }, on: { "click": function($event) {
      _vm.currentDay = _vm.currentDay.subtract(1, "week");
    } } }), _c("k-button", { attrs: { "icon": "angle-right", "variant": "filled", "theme": "blue" }, on: { "click": function($event) {
      _vm.currentDay = _vm.currentDay.add(1, "week");
    } } })], 1), _c("span", { staticClass: "week-label" }, [_vm._v(" " + _vm._s(_vm.displayWeeklabel) + " ")]), _c("k-button", { attrs: { "icon": "calendar", "theme": "blue", "variant": "filled" }, on: { "click": _vm.goToToday } }, [_vm._v(" " + _vm._s(_vm.$t("field.schedule.goToToday")) + " ")])], 1), _c("div", [_c("ScheduleTable", { attrs: { "current-locale": _vm.currentLocale, "time-range-start": _vm.timeRangeStart, "time-range-end": _vm.timeRangeEnd, "current-day": _vm.currentDay }, on: { "delete-event": _vm.deleteEvent, "create-event": _vm.createEvent, "edit-event": _vm.editEvent, "move-event": _vm.moveEvent } })], 1)]);
  };
  ...
  __component__.options.__file = "/home/jona-vdv/Documents/programming/projects/kirby-schedule-field/packages/kirby-schedule-field/src/components/schedule-item-area.vue";
